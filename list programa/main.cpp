            ...
            switch (strategija) {
                ...
                case 2: {
                    ...
                    cout  << fixed << setprecision(10) << "Failo is " << pradinisStudentuSkaicius
                          ...
                          << " sekundziu" << endl;
                    cout << fixed << "Irasu rusiavimo laikas: " << avgSort << " sekundziu" << endl;
                    cout << fixed << pradinisStudentuSkaicius << " irasu dalijimo i dvigrupes laikas: " << avgCategorize
                         << " sekundziu" << endl;
                    cout << fixed << vargsiukai.size() << " irasu vargsiuku irasymo i faila laikas: "
                         << avgWriteVargsiukai
                         << " sekundziu" << endl;
                    cout << fixed << pradinisStudentuSkaicius << " irasu testo laikas "
                ...
                case 3: {
                    ...
                    cout << fixed << "Irasu rusiavimo laikas: " << avgSort << " sekundziu" << endl;
                    cout << fixed << pradinisStudentuSkaicius << " irasu dalijimo i dvigrupes laikas: "
