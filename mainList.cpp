        ...
        if (duomenusaltinis == 'I' || duomenusaltinis == 'i') {
            ...
            switch (strategija) {
                case 1: {
                    ...
                    cout << "Failo is " << studentai.size() << " irasu nuskaitymo laikas: " << avgRead << " sekundziu" << endl;
                ...
                case 2: {
                    ...
                    cout << fixed << setprecision(10) << "Failo is " << pradinisStudentuSkaicius << " irasu nuskaitymo laikas: " << avgRead << flush
                         << " sekundziu" << endl;
                    cout << "Irasu rusiavimo laikas: " << avgSort << " sekundziu" << endl;
                ...
                case 3: {
                    ...
                    cout << "Failo is " << pradinisStudentuSkaicius << " irasu nuskaitymo laikas: "
